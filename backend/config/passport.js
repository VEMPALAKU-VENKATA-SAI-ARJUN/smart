...
// Only initialize Google OAuth if both client ID and secret are provided.
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
  ...
  // Warn but don't throw — this allows local dev without Google credentials.
  console.warn('Google OAuth not configured. To enable Google sign-in set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in your .env');
}
